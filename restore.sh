...
namespace=$1 #Kubernetes namespace where CB CI is deployed.
instanceStatefulsetName=$2 #The statefulset name of the OC or master deployment.
...
if [ -z $namespace ] || [ -z $instanceStatefulsetName ] || [ -z $s3Bucket ] || [ -z $backupFilePath ] || [ -z $rescueContainerImage ]
then
